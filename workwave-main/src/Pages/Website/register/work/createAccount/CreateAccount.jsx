    ...
    const createAccountWithGoogle = async (formData) => {
        try {
            ...
            setTimeout(() => {
                ...
                const addRoleToLocalStorage = localStorage.setItem('role',formData.role)
                const addFirstNameToLocalStorage = localStorage.setItem('firstName',formData.lastName)
                const addLastNameToLocalStorage = localStorage.setItem('lastName',formData.firstName)
                const addVerifiedToLocalStorage = localStorage.setItem('verified','true')
            }, 2500);
        } catch (err) {
