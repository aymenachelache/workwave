              ...
              whileInView={{
                ...
                transition: {
                  duration: 1 // Animation duration
                    ...
                    <Link to={role === "freelencer" ? 'addskills' : role == "user" ? 'profiledetails' : "/"} className={'btn-gradient block w-3/4 mx-auto mt-5'} ><span className='text-lg font-extrabold primaryfont block'>Set up my profile!</span></Link>
                </div>
            </motion.div >
        </>
    )
