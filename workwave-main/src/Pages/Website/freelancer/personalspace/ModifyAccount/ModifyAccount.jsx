    ...
    const handleSwitch = async (e) => {
        ...
        try {
            const response = await axios.put(`${baseURL}/${apiEndpoint}`, {}, {
                ...
                console.log(res);
                localStorage.setItem('role', role === 'freelencer' ? 'user' : 'freelancer');
                    ...
                    <div className="mx-auto mt-8">
                        <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                            ...
                            <img className={`object-cover w-40 h-40 p-1 rounded-full ring-2 ${localStorage.getItem('role') === 'freelancer' ? "ring-PrimColor" : "ring-SecColor"}`}
                                src={localStorage.getItem("photo") == "null" ? "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" : localStorage.getItem("photo")}
                                alt="Bordered avatar" />
                            <input
                                type="file"
                                ref={fileInputRef}
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="items-center mt-8 sm:mt-14 text-[#202142]">
                                <div className="flex flex-wrap">
                                    ...
                                    {localStorage.getItem("role") == "freelencer" &&
                                        <div className="p-2 w-full">
                                            <div className="relative">
                                    ...
                                    {localStorage.getItem("role") == "freelencer" &&
                                        <div className="p-2 w-full text-center">
                                            <Link to={"/register/welcome/addSkills"} className={'btn-gradient block w-full'}><span className='text-lg font-extrabold primaryfont block'>Edit Skills And Certificates</span></Link>
                                        </div>
                                    }
