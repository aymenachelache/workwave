                                                ...
                                                <div className=" bg-gray-50 h-96 overflow-y-auto pt-8 px-4 right-0">
                                                    ...
                                                    <div className="w-full p-3 mt-8 bg-white rounded flex">
                                                        ...
                                                        <div className="pl-3">
                                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none">
                                                                ...
                                                                <span className="text-indigo-700">item</span></p>
                                                    ...
                                                    <div className="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                                                        ...
                                                        <div className="pl-3 w-full">
                                                            <div className="flex items-center justify-between w-full">
                                                                <p tabIndex="0" className="focus:outline-none text-sm leading-none">
                                                                    <span className="text-indigo-700">Sash</span> added you to the group:
                                                                    <span className="text-indigo-700">UX Designers</span></p>
                                                                <div tabIndex="0" aria-label="close icon" role="button"
                                                                    className="focus:outline-none cursor-pointer">
                                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M10.5 3.5L3.5 10.5" stroke="#4B5563" strokeWidth="1.25" strokeLinecap="round"
                                                                            strokeLinejoin="round" />
                                                                        <path d="M3.5 3.5L10.5 10.5" stroke="#4B5563" strokeWidth="1.25" strokeLinecap="round"
                                                                            strokeLinejoin="round" />
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="w-full p-3 mt-4 bg-white rounded flex">
                                                        ...
                                                        <div className="pl-3">
                                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none">
                                                                ...
                                                                <span className="text-indigo-700">Update gone wrong</span></p>
                                                            <p tabIndex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                                                        </div>
                                                    </div>
                                                    <div className="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
                                                        ...
                                                        <div className="pl-3 w-full flex items-center justify-between">
                                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none text-red-700">Low on storage:
                                                                2.5/32gb remaining</p>
                                                            <p tabIndex="0"
                                                    ...
                                                    <div className="w-full p-3 mt-4 bg-white rounded flex">
                                                        ...
                                                        <div className="pl-3">
                                                            <p tabIndex="0" className="focus:outline-none text-sm leading-none">Shipmet delayed for
                                                                order<span className="text-indigo-700"> #25551</span></p>
                                                            <p tabIndex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                                                        </div>
                                                    </div>
                                                    <h2 tabIndex="0"
                                                    ...
                                                    <div className="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
                                                        ...
                                                        <div className="pl-3 w-full">
                                                            <div className="flex items-center justify-between">
                                                                <p tabIndex="0" className="focus:outline-none text-sm leading-none text-green-700">Design sprint
                                                                    completed</p>
                                                                <p tabIndex="0"
                                        ...
                                        <div onClick={() => {
                                            ...
                                            <div className={"relative border-b-4 border-transparent border-indigo-700 transform transition duration-300"}  x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100">
                                                ...
                                                <ul className="space-y-3 ">
                                                    ...
                                                    <li className="font-medium">
                                                    <Link to="/setting/publicprofile" className="flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:border-[#00AEEF]">
                                                        <div className="mr-3">
