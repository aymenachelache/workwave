        ...
        <div id="container" className={`FreelanceCard border border-gray-300 max-md:w-[80%] max-sm:w-[95%] w-[60%] rounded-3xl mt-10 ${isSlides ? "max-sm:p-5 p-10" : "w-full p-5"}`}>
            ...
            <div className="flex justify-between mt-12">
                ...
                <div id="buttons" className="flex items-center justify-center">
                    <Link to={"/contactus"} id="report" className="text-red-500 max-sm:hidden border-2 border-red-500 hover:bg-red-500 transition-all duration-200 hover:text-gray-50 rounded-xl flex justify-between items-center px-2 py-2">
