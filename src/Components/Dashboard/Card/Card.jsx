...
const Card = ({profit}) => {
    ...
    return (
        <div className="hover:-translate-y-3 cursor-pointer  flex-grow shadow-xl transition-all duration-300 lg:mt-4 h-fit hover:shadow-emerald-200 rounded-2xl p-8">
