    ...
    return(
        <div className=" rounded-2xl p-4 grid grid-cols-7 gap-6 font-Unbounded pb-2">
            <div className="col-span-3">
                <div id="title" className="font-semibold font-Unbounded text-sm py-1">{dataPiece.title}</div>
            ...
            <div className="col-span-2 text-sm px-4">
                <div className="grid grid-cols-2 items-center pt-1 pb-4">
                    <p className="font-Unbounded">Cost: </p> <p className="text-PrimColor font-bold font-Unbounded pl-3">${dataPiece.cost}</p>
                </div>
                <div className="grid grid-cols-2 items-center">
                    <p className="font-Unbounded">Sold: </p> <p className="font-Unbounded pl-3">{dataPiece.sold}</p>
                </div>
                <div className="grid grid-cols-2 items-center py-6">
                    <p className="font-Unbounded">Total Profit: </p> <p className="text-PrimColor font-bold font-Unbounded pl-3">${dataPiece.totalProfit}</p>
                </div>
            </div>
