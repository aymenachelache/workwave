...
const SkillsByProjectsRatio = () => {

      return (
        <div className="shadow-xl p-8 rounded-2xl w-fit">
          <p className="font-semibold text-PrimColor text-opacity-50 mb-8">Skills By Projects Ration</p>
              ...
              {data.map((dataPiece, index) => {
                if (index > 0) return (
                  <li key={index} className="pl-4 items-center flex">
                    <div className={`h-2 w-2 mr-2 rounded-full ${colors[index]}`}></div>
