...
import { CreatePaymentAccount } from '../../../../../Components/Payment/CreatePaymentAccount';
        ...
        <>
            <motion.div
                ...
                <div className="contain payment-methode w-3/4 mx-auto text-center">
                    <span className='capitalize'><TextGradient size='25px' weight='800' text={`Welcome ${localStorage.getItem("firstName")}!`} /></span>
                    <motion.p
                        initial={{
                            opacity: 0,
                            // if odd index card,slide from right instead of left
