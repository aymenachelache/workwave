    ...
    const handleImageChange = async (e) => {
        ...
        try {
            const response = await axios.post(`${baseURL}/${PROFILEPICTURE}`, formData, {
                ...
                localStorage.setItem("photo", res.data.image?.url);
                ...
                <div className="contain w-2/4 mx-auto text-center">
                    ...
                    <div className="flex items-center gap-8">
                        <div
                            ...
                            className="avatar w-20 h-20 rounded-full cursor-pointer text bg-white" style={{ backgroundImage: `url(${localStorage.getItem("photo") == null || localStorage.getItem("photo") == "" ? "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" : localStorage.getItem("photo")})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            {/* Hidden file input */}
                            <input
                                type="file"
                                ref={fileInputRef}
                        ...
                        <div className="details text-left">
                            ...
                            <p className='text-lg font-normal capitalize'>{`${role == "user" ? "client" : role}`}</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {role === 'freelencer' && <InputComp onchange={(e) => handleChange(e)} type="text" name="portfolio_url" id="portfolio_url" className='w-full text-sm outline-none px-4 py-3 my-4 mx-auto' placeholder='Portfolio Link' />}
