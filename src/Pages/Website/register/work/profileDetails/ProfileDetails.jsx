                ...
                <div className="contain w-2/4 mx-auto text-center">
                    ...
                    <div className="flex items-center gap-8">
                        <div
                            ...
                            className="avatar w-20 h-20 rounded-full cursor-pointer text bg-white" style={{ backgroundImage: `url(${localStorage.getItem("photo") == "null" ? "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" : localStorage.getItem("photo")})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            {/* Hidden file input */}
                            <input
                                type="file"
                                ref={fileInputRef}
